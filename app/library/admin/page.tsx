      ...
      <div style={{maxWidth:640,margin:'0 auto',padding:'0 24px'}}>
        ...
        <div style={{padding:'40px 0 32px',borderBottom:'1px solid #E8E4DF',marginBottom:40}}>
          <div style={{display:'flex',flexDirection:'column',gap:10}}>
            <a href="/library/admin/catalog" style={{fontSize:16,color:'#111110',textDecoration:'none',display:'flex',alignItems:'center',gap:8}}>
              <span>🔒</span> Catalog →
            </a>
            <a href="/library" style={{fontSize:16,color:'#111110',textDecoration:'none',display:'flex',alignItems:'center',gap:8}}>
              <span>🌐</span> Library →
            </a>
          </div>
        </div>
